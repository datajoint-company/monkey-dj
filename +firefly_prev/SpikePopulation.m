%{
# Spike population data (channel-based spike times and event markers)
-> firefly.Session 
...
classdef SpikePopulation < dj.Imported
        ...
        function makeTuples(self,key)
            ...
            for i=1:numbrainareas
                ...
                for j=1:numtrials
                    ...
                    [key.channel_id,indx] = unique([neurons.channel_id]);
                    key.electrode_id = [neurons(indx).electrode_id];
                    key.electrode_type = {neurons(indx).electrode_type};
                    neurons = MergeNeuronsByChannel(neurons,key.channel_id);
                    %% concatenate units
