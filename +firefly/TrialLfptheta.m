%{
# Single-trial theta lfp data (voltage)
-> firefly.Lfp
-> firefly.Event
...
classdef TrialLfptheta < dj.Computed
    methods(Access=protected)
        function makeTuples(self,key)
            ...
            trials = SegmentLfpData(lfp_data,event_data,analysisprs,'theta');
            key.lfp_freqrange = analysisprs.lfp_theta;
